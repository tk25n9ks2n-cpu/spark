    ...
    <div className="auth-shell">
      <div className="auth-frame">
        ...
        <div className="auth-brand">
          <div className="anim-float auth-logo-wrap">
            <div className="auth-logo-ring">
              <div className="auth-logo">
                <img src="/logo.png" alt="Spark" className="auth-logo-img" />
              </div>
            </div>
          </div>
          <h1 className="auth-title">spark</h1>
          <p className="auth-tagline">
            Connect · Share · Meet <Heart size={14} fill="currentColor" color="currentColor" />
          </p>
        </div>
        ...
        <div className="animate-fade-up auth-card">
          ...
          <div className="auth-toggle">
            {['Log In', 'Sign Up'].map((label, i) => (
              <button
                ...
                className={`auth-toggle-btn ${(isLogin ? i === 0 : i === 1) ? 'active' : ''}`}
              >
                {label}
              </button>
            ))}
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            {error && (
              <div className="animate-fade-up auth-error">
                ⚠️ {error}
              </div>
            )}
          ...
          <p className="auth-legal">
            ...
            <span style={{ color: 'rgba(255,68,88,0.8)', cursor: 'pointer' }}>Terms</span> &amp;{' '}
            <span style={{ color: 'rgba(255,68,88,0.8)', cursor: 'pointer' }}>Privacy Policy</span>
          </p>
        </div>
      </div>
